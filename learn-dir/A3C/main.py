...
from sharedAdam import ShAdam, ShRMSProp
...
if __name__ == '__main__':
    ...
    if params['use_pre_trained'] == False:
        ...
        shared_ac = A3C(input_shape=layers_['n_frames'], layer1=layers_['hidden_dim1'], kernel_size1=layers_['kernel_size1'], stride1=layers_['stride1'], layer2=layers_['hidden_dim2'],
        ...
        if params['optimizer'] == 'adam':
            optimizer = ShAdam(shared_ac.parameters(), lr=params['lr'])
            optimizer.share_mem()
        elif params['optimizer'] == 'rmsprop':
            optimizer = ShRMSProp(shared_ac.parameters(), lr=params['lr'])
